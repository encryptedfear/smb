		...
		form: []Form{
			...
			Form{
				...
				Elmnts: []FormElement{
					...
					FormElement{Name: "telemetry", Type: "boolean", Default: false, Description: "We won't share anything with any third party. This will only to be used to improve this app"},
				},
			},
			Form{
				Title: "email",
