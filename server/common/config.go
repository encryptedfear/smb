		...
		form: []Form{
			Form{
				...
				Elmnts: []FormElement{
					...
					FormElement{Name: "host", Type: "text", Description: "The host people need to use to access this server", Placeholder: "Eg: \"demo.file-transfer.app\""},
...
func (this Configuration) Save() Configuration {
	...
	if err != nil {
		Log.Error("File-Transfer Utility needs to be able to create/edit its own configuration which it can't at the moment. Change the permission for File-Transfer Utility to create and edit `%s`", configPath)
		return this
	}
	defer file.Close()
